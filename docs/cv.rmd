...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _rafaelul.github.io/resume/_")
} else {
  cat("[<i class='fas fa-download'></i> Download PDF](https://github.com/RafaelUL/resume/blob/master/docs/cv.pdf)")
}
```
